...
const OurWork = () => {
    ...
    const workData = [
    {
        ...
        description: 'Boost user engagement and downloads through strategic app campaigns.',
        image: assets.work_mobile_app
    },
    {
        title: 'Dashboard Management',
        description: 'Streamline data visualization and analytics for better decision-making.',
        image: assets.work_dashboard_management
    },
    {
        title: 'Fitness App Promotion',
        description: 'Increase app visibility and subscriptions with targeted fitness campaigns.',
